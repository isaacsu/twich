            ...
            <div id="connect">
                <form action="#">
                    <fieldset> 
                        ...
                        <p style='font-size:12px;color:#aaa;font-style:italic'>No pesky signups or registration forms - how delightful!</p>
                        ...
                        <div style='line-height:18px;font-size:14px;color:#666;margin-top:50px; font-family: Arial, sans-serif'>
                            ...
                            <p>twich.me is developed by <span style='color:#aaa'>isaac@pregnate.com.au</a></p>
                        </div>
